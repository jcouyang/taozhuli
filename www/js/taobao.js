...
// serviceURL = 'http://192.168.1.151:8000/taobao/'
// loginURL = 'http://192.168.1.151:8000/login/taobao/'
...
function logout(){
    ...
    else if('undefined' != typeof blackberry)
    {
        blackberry.polarmobile.childbrowser.loadURL(loginURL);
...
function getSoldList() {
    // requestToken();
    // alert(getToken())
    // var args = new blackberry.invoke.BrowserArguments(taobaoURL);
